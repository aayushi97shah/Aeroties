...
<!-- Contact Form area starts -->
    ...
    <!-- //col-md-6 -->
     <div class="contact-form col-md-6">
                ...
                <form id="ajax-contact" action="reg_insert.php" method="post" class="comment-form" id="contact_insert">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input name="phone" id="phone" type="text" placeholder="Mobile No" required="required">
